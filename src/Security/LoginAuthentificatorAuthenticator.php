...
class LoginAuthentificatorAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        $csrfToken = $request->request->get('_csrf_token'); // Récupérer le CSRF token

        if (!$email || !$password || !$csrfToken) {
            throw new \InvalidArgumentException('Missing login credentials');
        }
    ...
    {
        // Redirection vers la page "artiste_index"
